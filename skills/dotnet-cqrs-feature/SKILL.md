...
description: Add new features to a .NET API using CQRS/MediatR — commands, queries, handlers, entities, validators, and EF migrations. Use when the user asks to add an endpoint, create a new feature, add a new entity, or implement CQRS in a .NET project.
license: CC-BY-ND-4.0
---

# .NET CQRS / MediatR Feature
