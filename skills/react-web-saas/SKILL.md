---
name: react-web-saas
description: Add new pages, features, or API integrations to a React (Vite + TypeScript + Tailwind) web app. Use when the user asks to add a page, React component, web UI feature, form, table, or dashboard section.
