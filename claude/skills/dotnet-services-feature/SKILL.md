...
description: Add new features to a .NET API using traditional services architecture — entities, DTOs, service interface + implementation, controller, and EF migrations.
when_to_use: Use when the user asks to add an endpoint, create a new feature, add a new entity, or build a service in a .NET project.
---
