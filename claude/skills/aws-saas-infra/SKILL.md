---
name: aws-saas-infra
description: Manage AWS infrastructure for a QBS SaaS project using Terraform. Covers first-time setup, adding resources (Lambda, CloudFront, RDS, S3), deployments, and troubleshooting.
when_to_use: Use when the user mentions Terraform, AWS, Lambda, CloudFront, RDS, infra setup, or deployment infrastructure.
---
...
infra/terraform/
  ...
  rds.tf             # PostgreSQL RDS (optional)
  outputs.tf         # API URL, CF domain, bucket name, etc.
