...
description: Run a security review on a new feature, endpoint, or entity in a QBS SaaS project. Covers auth, tenant isolation, data encryption, input validation, secrets, logging, and infrastructure hardening.
when_to_use: Use when the user asks for a security review, security checklist, "is this secure", or when completing a new feature that handles sensitive data.
---
