...
description: Add new screens or features to a React Native Expo app. Covers screen creation, navigation, API integration, and UI patterns.
when_to_use: Use when the user asks to add a screen, mobile page, React Native component, Expo screen, or mobile feature.
---
