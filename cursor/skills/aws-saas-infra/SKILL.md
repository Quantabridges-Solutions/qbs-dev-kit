---
name: aws-saas-infra
description: Manage AWS infrastructure for a QBS SaaS project using Terraform. Covers first-time setup, adding resources (Lambda, CloudFront, RDS, S3), deployments, and troubleshooting. Use when the user mentions Terraform, AWS, Lambda, CloudFront, RDS, infra setup, or deployment infrastructure.
---
