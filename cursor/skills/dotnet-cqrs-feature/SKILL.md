...
description: Add new features to a .NET 8 clean architecture API — commands, queries, entities, controllers, validators, and EF migrations. Use when the user asks to add an endpoint, create a new feature, add a new entity, or implement CQRS in a .NET project.
---
